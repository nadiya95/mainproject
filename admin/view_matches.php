...
// Fetch matches from the database where status is 'accepted'
$query = "
    SELECT sender, receiver, matched_on
    FROM interests 
...
<head>
    ...
    <title>View Matches - Vows and Values</title>
    ...
    <style>
        ...
        header {
            background-color: #c06169; /* Primary color */
            color: #fff;
            padding: 1rem;
            text-align: center;
        }
