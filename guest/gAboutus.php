...
<body>
    ...
    <div class="container">
        ...
        <section class="about-us">
            ...
            <p>
                At <strong>Vows and Values</strong>, we believe that marriage is more than just a union—it's a connection of two souls, two families, and two worlds. Our mission? To make that connection as meaningful and joyful as possible!
            </p>
    ...
    <div class="banner-content">
        ...
        <a href="success-stories.php" class="btn">Read Their Stories</a>
            ...
            <p>
                At <strong>Vows and Values</strong>, we promise to provide a safe, respectful, and joyful environment where you can find your perfect match. True love isn’t just about finding someone to marry; it’s about finding someone who makes your life complete.
            </p>
    ...
    <div class="footer-content">
        ...
        <div class="contact-info">
            <div class="email-info">
                <span class="mail-symbol">✉️</span>
                <p>vows@gmail.com</p>
            </div>
            <div class="vertical-line">|</div>
            <div class="social-info">
                <a href="https://www.instagram.com/yourprofile" target="_blank" class="insta-symbol">
