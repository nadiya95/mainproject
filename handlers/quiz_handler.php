...
if(isset($_POST['register'])){
   ...
   global $conn;
   $sql="INSERT INTO user(username,password,email,fullName,dob,age,gender,religion,sects,state,district,primaryNo,secondaryNo,height,weight,complexion,appearance,bodyType,fatherName,motherName,siblings,familyValues,occupation,companyName,annualIncome,education,bio,profilePic,profileVideo,hashtags,Max_age,Min_age,heightPreference,religionPreference,educationPreference,otherPreference)VALUES ('$username','$password','$email','$fullName','$dob','$age','$gender','$religion','$sects','$state','$district','$primaryNum','$secondaryNum','$height','$weight','$complexion','$appearance','$bodyType','$fatherName','$motherName','$siblings','$familyValues','$occupation','$companyName','$annualIncome','$education','$bio','$profilePic','$profileVideo','$hashtags','$Max_age','$Min_age','$heightPreference','$religionPreference','$educationPreference','$otherPreference')";
