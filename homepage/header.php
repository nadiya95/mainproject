...
<header>
    ...
    <nav>
        <ul>
            ...
            <li><a href="../homepage/matches.php"><i class="fas fa-heart"></i> Matches</a></li>
            <li><a href="../homepage/notifications.php"><i class="fas fa-bell"></i> Notifications</a></li>
            <li><a href="../homepageabout.php"><i class="fas fa-info-circle"></i> About Us</a></li>
            <li><a href="../homepage/profile.php"><i class="fas fa-user"></i> Profile</a></li>
        </ul>
    </nav>
