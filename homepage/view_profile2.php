...
// Check if a notification ID is passed in the URL
if (isset($_GET['notification_id'])) {
    $notification_id = intval($_GET['notification_id']); // Get the notification ID
    $update_sql = "UPDATE interests SET is_read = 1 WHERE id = $notification_id"; // Update query
    mysqli_query($conn, $update_sql); // Execute the query
}
